            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text('Registrarse', style: TextStyle(color:Color(0XFF480E0A),fontSize:33),),
                  SizedBox(
                    height:size.height*0.02
                  ),
                  Container(
                      ...
                      child: Center(
                        ...
                        child: RaisedButton(
                          child: Padding(
                            ...
                            child: Text('Registrarse', style: TextStyle(color:Color(0xFF480E0A), fontSize:20, fontWeight: FontWeight.bold)),
                            ),
