    ...
    return Container(
      child: Column(
          children: [
            ...
            Input(hinText: 'Apellido',icon: Icons.description_outlined),
            SizedBox(height: 15.0),
            Input(hinText: 'Rol',icon: Icons.request_quote_outlined),
            SizedBox(height: 15.0),
            Input(hinText: 'nombre de usuario',icon: Icons.inventory),
            Container(
              width: 100,
              height: 100,
              child: Image(
